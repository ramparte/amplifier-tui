...
_PALETTE_COMMANDS: tuple[tuple[str, str, str], ...] = (
    ...
    ("/context", "Context window profiler with stacked bar breakdown", "/context"),
    ("/context detail", "Per-message token estimates by category", "/context detail"),
    ("/context history", "Sparkline of context usage over time", "/context history"),
    ("/context top", "Largest items consuming context", "/context top"),
    ...
    ("/fork", "Create a named branch or fork into a new tab", "/fork"),
    ("/fork <name>", "Create a named conversation branch", "/fork "),
    ("/fork N", "Fork from message N (from bottom) into a new tab", "/fork "),
    ("/branches", "Show conversation branch tree", "/branches"),
    ("/branch", "Show current branch info", "/branch"),
    ("/branch switch", "Switch to a named branch", "/branch switch "),
    ("/branch compare", "Compare two branches side-by-side", "/branch compare "),
    ("/branch merge", "Merge messages from a branch", "/branch merge "),
    ("/branch delete", "Delete a named branch", "/branch delete "),
    ("/branch list", "List all branches (same as /branches)", "/branch list"),
    ...
    ("/replay", "Session replay (play back any session)", "/replay"),
    ("/replay status", "Current replay state and progress", "/replay status"),
    ("/replay pause", "Pause session replay", "/replay pause"),
    ("/replay resume", "Resume paused replay", "/replay resume"),
    ("/replay skip", "Skip to next message in replay", "/replay skip"),
    ("/replay stop", "Stop session replay", "/replay stop"),
    ("/replay speed", "Set replay speed (0.5x, 1x, 2x, 5x, instant)", "/replay speed "),
    (
        "/replay timeline",
        "Show timeline window around current position",
        "/replay timeline",
    ),
