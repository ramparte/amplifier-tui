...
_PALETTE_COMMANDS: tuple[tuple[str, str, str], ...] = (
    ...
    ("/workspace", "Show or set project workspace directory", "/workspace"),
    ("/workspace set", "Set workspace to a directory", "/workspace "),
    ("/environment", "Full Amplifier install diagnostics", "/environment"),
    ("/env", "Full Amplifier install diagnostics (alias)", "/environment"),
    ...
    ("/project", "Show project info for current session", "/project"),
    ("/project ask", "Ask AI about your project's sessions", "/project ask"),
    ("/project search", "Search across project sessions", "/project search "),
    ("/projector", "Toggle Projector project panel", "/projector"),
    ("/projector projects", "List all Projector projects", "/projector projects"),
    ("/projector tasks", "Show tasks for current or named project", "/projector tasks"),
    ("/projector strategies", "List active strategies", "/projector strategies"),
    (
        "/projector status",
        "Show Projector context for working directory",
        "/projector status",
    ),
    (
        "/projector outcomes",
